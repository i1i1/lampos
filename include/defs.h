...
#define COM1_PORT_ADDRESS	(KERNEL_BASE + 0x3f8)
#define COM2_PORT_ADDRESS	(KERNEL_BASE + 0x2f8)
#define COM3_PORT_ADDRESS	(KERNEL_BASE + 0x3e8)
#define COM4_PORT_ADDRESS	(KERNEL_BASE + 0x2e8)
